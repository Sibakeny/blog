...
ActiveRecord::Schema.define(version: 2020_09_05_091053) do
  ...
  create_table "qiita_stats", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "article_id"
    t.integer "page_view_count"
    t.integer "like_count"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_qiita_stats_on_article_id"
  end
  ...
  add_foreign_key "qiita_stats", "articles"
end
